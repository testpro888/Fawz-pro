/**
 * Saham Holidays Module (root-level entry point)
 ...
 *
 * This file re-exports the canonical implementation from js/saham-holidays.js
 * and also populates window.SahamHolidays for browser / test environments.
 */
(function () {
  'use strict';
  ...
  // Export via window.SahamHolidays namespace (used by browser and vitest node environment)
  var exports = {
  ...
  if (typeof window !== 'undefined') {
    window.SahamHolidays = exports;
  } else if (typeof globalThis !== 'undefined') {
    globalThis.window = globalThis.window || {};
    globalThis.window.SahamHolidays = exports;
  }
})();
